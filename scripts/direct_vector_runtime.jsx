(function () {
  if (typeof VECTOR_DIRECT_CONFIG === "undefined") {
    return "ERROR|Missing VECTOR_DIRECT_CONFIG|0|configuration";
  }

  var config = VECTOR_DIRECT_CONFIG;
  var sourceDoc = null;
  ...
  try {
    ...
    if (!batchMode) {
      ...
      validationGroup.name = "VECTOR_NON_UI_PREFLIGHT";
