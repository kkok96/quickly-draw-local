(function () {
  if (typeof VECTOR_PLAYBACK_CONFIG === "undefined") {
    return "ERROR|Missing VECTOR_PLAYBACK_CONFIG";
  }

  var config = VECTOR_PLAYBACK_CONFIG;
  ...
  function writeGeometry(pathData, destination, viewBox, scale, originLeft, originTop, forceMode) {
    ...
    // Use setEntirePath when the connected Illustrator runtime supports it;
  ...
  function drawBatch() {
    ...
    for (var atomIndex = 0; atomIndex < payload.atoms.length; atomIndex += 1) {
      ...
      try {
        ...
        createdCount += 1;
        app.redraw();
        // Long Illustrator sessions can retain native PathPoint proxies
