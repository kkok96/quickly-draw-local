...
$runner = Join-Path $PSScriptRoot "run_vector_playback.ps1"
...
$internalRoot = Join-Path $jobRoot ".local-vector-internal\live-cache"
...
& $vectorizer -InputImage $inputPath -OutputSvg $rawSvg -BaseUrl $BaseUrl | Out-Null
